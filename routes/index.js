...
router.get('/login', function(req, ress, next) {
    ...
    function connect_to_login2(res){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("data", function(d){});
            r.on("end", function(){ connect_to_authengine(r);})
        });
        req.end();
    }
    ...
    function connect_to_authengine(res){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("data", function(d){});
            r.on("end", function(){connect_to_remoteUser(r);})
        });
        req.end();
    }
    ...
    function connect_to_remoteUser(res){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("data", function(d){});
            r.on("end", function(){connect_to_login2service(r);})
        });
        req.end();
    }
    ...
    function connect_to_login2service(res){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("data", function(d){});
            r.on("end", function(){connect_to_login2service2(r);})
        });
        req.end();
    }
    ...
    function connect_to_login2service2(res){
        ...
        var rawHtml =  decoder.write(cent);
          ...
          submit = $("[name='submit']").attr("value");
            ...
            r.on("end", function(){
                post_to_login2(r, path2, lt, execution, submit);
            })
        });
        req.end();
    }
    ...
    function post_to_login2(res, path2, lt, execution, submit){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("end", function(){
                connect_to_login2_after_post(r)
            })
        });
        req.write(post_data);
        req.end();
    ...
    function connect_to_login2_after_post(res){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("data", function(d){});
            r.on("end", function(){connect_to_login2_after_post2(r)})
        });
        req.end();
    }
    ...
    function connect_to_login2_after_post2(res){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("end", function(){
                connect_to_login2_after_post3(r)
            })
        });
        req.end();
    }
    ...
    function connect_to_login2_after_post3(res){
        ...
        var req = https.request(options, function(r) {
            ...
            r.on("end", function(){
                ...
                connect_to_login2_after_post4(r, RelayState, SAMLResponse);
    ...
    function connect_to_shibolet(res){
        ...
        var req = https.request(options, function(r) {
            r.on("data", function(d){});
            r.on("end", function(){get_user_info(r)})
        });
        req.end();
    }
